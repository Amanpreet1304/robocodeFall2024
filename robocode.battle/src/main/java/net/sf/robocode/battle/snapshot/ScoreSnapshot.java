...
public final class ScoreSnapshot implements Serializable, IXmlSerializable, IScoreSnapshot {
    ...
    /**
     * Creates a snapshot of a score based on two sets of scores that are added
     * together.
     * 
     * @param contestantName the name of the contestant.
     * @param score1         the contestant's first set of scores to base this
     *                       snapshot on.
     * @param score2         the contestant's second set of scores that must be
     *                       added to the first set of scores.
     */
    ...
    public void writeXml(XmlWriter writer, SerializableOptions options) throws IOException {
        ...
        writeScoreAttributes(writer, options);
        writer.endElement();
    }

    private void writeScoreAttributes(XmlWriter writer, SerializableOptions options) throws IOException {
        ...
        if (!options.skipTotal) {
            ...
            writer.writeAttribute(options.shortAttributes ? "tbk" : "totalBulletKillBonus", totalBulletKillBonus,
                    options.trimPrecision);
            writer.writeAttribute(options.shortAttributes ? "trd" : "totalRammingDamageScore", totalRammingDamageScore,
                    options.trimPrecision);
        ...
        writer.writeAttribute(options.shortAttributes ? "bk" : "currentBulletKillBonus", currentBulletKillBonus,
                options.trimPrecision);
        writer.writeAttribute(options.shortAttributes ? "rd" : "currentRammingDamageScore", currentRammingDamageScore,
                options.trimPrecision);
    ...
    public boolean equals(Object obj) {
        ...
        if (Double.doubleToLongBits(currentBulletDamageScore) != Double
                .doubleToLongBits(other.currentBulletDamageScore)) {
            return false;
        }
        if (Double.doubleToLongBits(currentBulletKillBonus) != Double.doubleToLongBits(other.currentBulletKillBonus)) {
            return false;
        }
        if (Double.doubleToLongBits(currentRammingDamageScore) != Double
                .doubleToLongBits(other.currentRammingDamageScore)) {
            return false;
        }
        if (Double.doubleToLongBits(currentRammingKillBonus) != Double
                .doubleToLongBits(other.currentRammingKillBonus)) {
            return false;
        }
        ...
        if (Double.doubleToLongBits(totalRammingDamageScore) != Double
                .doubleToLongBits(other.totalRammingDamageScore)) {
            return false;
        }
